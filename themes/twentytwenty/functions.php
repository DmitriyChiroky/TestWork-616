...
require get_template_directory() . '/inc/functions-1.php';

function monovento_scripts() {
	wp_enqueue_style( 'twe-style', get_template_directory_uri() . '/assets/css/style-1.css');
	wp_enqueue_script( 'script-1', get_template_directory_uri() . '/assets/js/script-1.js', array('jquery'), true );

    wp_localize_script( 'script-1', 'twe_object', array(
        'ajax_url' => admin_url( 'admin-ajax.php' ),
        'site_url' => site_url('/'),
        'dir' => get_stylesheet_directory_uri(),
    ) );
}
add_action( 'wp_enqueue_scripts', 'monovento_scripts' );

function enqueuing_admin_scripts(){
	    wp_enqueue_style('style-admin', get_template_directory_uri(). '/assets/css/style-admin.css');
    	wp_enqueue_script( 'script-admin', get_template_directory_uri() . '/assets/js/script-admin.js', array('jquery'), true );
     wp_localize_script( 'script-admin', 'twe_object', array(
        'ajax_url' => admin_url( 'admin-ajax.php' ),
        'site_url' => site_url('/'),
        'dir' => get_stylesheet_directory_uri(),
    ) );
